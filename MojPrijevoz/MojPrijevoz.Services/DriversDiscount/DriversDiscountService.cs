...
public class DriversDiscountService : BaseCrudService<Database.DriversDiscount, DriversDiscountUpsertRequest,
    DriversDiscountUpsertRequest, DriversDiscountResponse, DriversDiscountSearchObject>
{
    public DriversDiscountService(MojPrijevozDbContext context, IMapper mapper,
    ...
    protected override async Task BeforeUpdate(int id, DriversDiscountUpsertRequest request,
        Database.DriversDiscount entity)
    {
