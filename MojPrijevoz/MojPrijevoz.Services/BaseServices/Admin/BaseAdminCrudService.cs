...
public abstract class
    BaseAdminCrudService<TEntity, TInsertRequest, TUpdateRequest, TRequestChangesEntity, TResponse, TAllResponse, TSearchObject> :
    ...
    public BaseAdminCrudService(MojPrijevozDbContext context, IMapper mapper, AuthorizationService authorizationService) :
        base(context, mapper) {
