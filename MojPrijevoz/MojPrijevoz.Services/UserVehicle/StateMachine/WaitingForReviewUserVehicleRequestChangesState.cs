...
public class WaitingForReviewUserVehicleRequestChangesState : BaseUserVehicleRequestChangesState
{
    public WaitingForReviewUserVehicleRequestChangesState(IServiceProvider serviceProvider,
